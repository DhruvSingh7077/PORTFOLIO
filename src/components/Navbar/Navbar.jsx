  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] lg:px-[20vw] ${
        isScrolled
          ? "bg-[#050414] bg-opacity-50 background-blur-md shadow-md"
          : "bg-transparent"
      }`}
    >
      <div className="text-white py-5 flex justify-between items -center">
        ...
        <div className="hidden md:flex space-x-4">
          <a
            href="https://github.com/DhruvSingh7077"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/dhruv-singh70/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-[#8245ec]"
          >
        ...
        <div className="md:hidden">
          {isOpen ? (
            <FiX
              className="text-3xl text-[#8245ec] cursor pointed"
