...
//https://phyniks.com/hubfs/favicon.ico
...
export const experiences = [
  {
    ...
    company: "Phyniks Dream Labs LLP",
    date: "September 2025 - Present",
    desc: "Contributing in dynamic and scalable web applications using Nest & Next js, handling both frontend and backend development. Collaborated with cross-functional teams to build responsive UI, implement RESTful APIs, and optimize application performance in an agile environment.",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
...
export const education = [
  ...
  // },
  {
    id: 1,
    // img: bsaLogo,
    school: "Acharya College, Bangalore",
    date: " 2022 -  2026",
    grade: "7 CGPA",
    desc: "I am Doing my Bachelor's degree in Computer Science  from  Acharya Institute of Technology, Banglore. Throughout my studies, I was immersed in a variety of subjects that deepened my understanding of computing and technology. From exploring Data Structures and Algorithms to diving into Web Development and Database Management Systems, I gained practical insights into the world of software development. My time at Acharya College allowed me to work on projects that applied theoretical concepts to real-world problems.",
  ...
  },
  {
    ...
    date: "2020-2021",
    grade: "80%",
    desc: "I completed my class 12 education from St Marys Convent School, Gajraula, under the CBSE board, where I studied Physics, Chemistry, and Mathematics (PCM) with Physical Education.",
